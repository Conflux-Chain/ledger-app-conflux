...
void eth_write_u64_be(uint8_t *buffer, uint64_t value) {
...
void eth_read_u64_be(uint8_t *in, uint64_t *out) {
...
void mul256(uint256_t *number1, uint256_t *number2, uint256_t *target) {
    ...
    for (uint8_t i = 0; i < 4; i++) {
        eth_write_u64_be(num1 + i * sizeof(uint64_t), number1->elements[i / 2].elements[i % 2]);
        eth_write_u64_be(num2 + i * sizeof(uint64_t), number2->elements[i / 2].elements[i % 2]);
    }
